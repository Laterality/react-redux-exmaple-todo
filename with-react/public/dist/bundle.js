...
(function (todoActionTypes) {
    todoActionTypes["ADD_TODO"] = "TODO_ADD";
    todoActionTypes["REMOVE_TODO"] = "TODO_REMOVE";
    todoActionTypes["COMPLETE_TODO"] = "TODO_COMPLETE";
    todoActionTypes["CHANGE_VISIBILITY"] = "SET_VISIBILITY";
})(todoActionTypes = exports.todoActionTypes || (exports.todoActionTypes = {}));
var todoVisibility;
(function (todoVisibility) {
    todoVisibility["SHOW_ALL"] = "SHOW_ALL";
    todoVisibility["SHOW_TODO"] = "SHOW_TODO";
    todoVisibility["SHOW_COMPLETED"] = "SHOW_COMPLETED";
})(todoVisibility = exports.todoVisibility || (exports.todoVisibility = {}));
class TodoActionCreator {
    static addTodo(text, id) {
        return {
    ...
    static changeVisibility(visibility) {
        return {
...
exports.TodoActionCreator = TodoActionCreator;
...
const todoInput_component_1 = __webpack_require__(/*! ./todoInput/todoInput.component */ "./src/component/todoInput/todoInput.component.tsx");
const todoList_container_1 = __webpack_require__(/*! ./todoList/todoList.container */ "./src/component/todoList/todoList.container.tsx");
const todoVisibilitySelector_1 = __webpack_require__(/*! ./todoVisibilitySelector/todoVisibilitySelector */ "./src/component/todoVisibilitySelector/todoVisibilitySelector.tsx");
class App extends React.Component {
    render() {
        return (React.createElement("div", null,
            React.createElement(todoInput_component_1.default, null),
            React.createElement(todoVisibilitySelector_1.default, null),
            React.createElement(todoList_container_1.default, null)));
    }
}
exports.App = App;
...
const todo_1 = __webpack_require__(/*! ../../action/todo */ "./src/action/todo.ts");
let idNext = 1;
class TodoInput extends React.Component {
    constructor() {
        super(...arguments);
        this.onInputButtonClick = () => {
    ...
    render() {
        return (React.createElement("div", null,
            React.createElement("input", { id: "todoInput", type: "text" }),
            React.createElement("button", { onClick: this.onInputButtonClick }, "ADD")));
    }
}
const dispatchToProp = (dispatch) => {
    return {
        onClick: (input) => {
            dispatch(todo_1.TodoActionCreator.addTodo(input, idNext++));
        },
    };
};
exports.default = react_redux_1.connect(null, dispatchToProp)(TodoInput);


/***/ }),

/***/ "./src/component/todoList/todoList.container.tsx":
/*!*******************************************************!*\
  !*** ./src/component/todoList/todoList.container.tsx ***!
  \*******************************************************/
/*! no static exports found */
...
const react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
const todo_1 = __webpack_require__(/*! ../../action/todo */ "./src/action/todo.ts");
const todo_obj_1 = __webpack_require__(/*! ../../lib/todo.obj */ "./src/lib/todo.obj.ts");
const todoListItem_component_1 = __webpack_require__(/*! ./todoListItem.component */ "./src/component/todoList/todoListItem.component.tsx");
class TodoList extends React.Component {
    render() {
        return (React.createElement("ul", null, this.props.todos.map((todo) => {
            return React.createElement(todoListItem_component_1.Todo, { key: todo.getId(), onClick: this.props.onTodoItemClick, todo: todo });
        })));
    }
}
// Send state Store -> Container
const todoListToProp = (state) => {
    return {
        todos: state.todos.filter((item) => {
            switch (state.visibility) {
                case todo_1.todoVisibility.SHOW_ALL:
                    return true;
                case todo_1.todoVisibility.SHOW_TODO:
                    return item.getState() === todo_obj_1.TodoState.TODO;
                case todo_1.todoVisibility.SHOW_COMPLETED:
                    return item.getState() === todo_obj_1.TodoState.COMPLETED;
            }
        }),
    };
};
...
const todoListDispatchToProps = (dispatch) => {
    return {
        onTodoItemClick: (id) => {
            dispatch(todo_1.TodoActionCreator.completeTodo(id));
        },
    };
};
exports.default = react_redux_1.connect(todoListToProp, todoListDispatchToProps)(TodoList);
...
class Todo extends React.Component {
    render() {
        return (React.createElement("li", { style: {
                textDecoration: this.props.todo.getState() === todo_obj_1.TodoState.COMPLETED ?
                    "line-through" : "none",
            }, onClick: () => this.props.onClick((this.props.todo.getId())) }, this.props.todo.getText()));
    }
}
exports.Todo = Todo;
...
const react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
const todo_1 = __webpack_require__(/*! ../../action/todo */ "./src/action/todo.ts");
class TodoVisibilitySelector extends React.Component {
    render() {
        return (React.createElement("form", null,
            React.createElement("input", { type: "radio", name: "visibility", id: "show-all", onClick: () => this.props.onVisibilityChanged(todo_1.todoVisibility.SHOW_ALL) }),
            React.createElement("label", { htmlFor: "show-all" }, "Show all"),
            React.createElement("input", { type: "radio", name: "visibility", id: "show-todo", onClick: () => this.props.onVisibilityChanged(todo_1.todoVisibility.SHOW_TODO) }),
            React.createElement("label", { htmlFor: "show-todo" }, "Todo"),
            React.createElement("input", { type: "radio", name: "visibility", id: "show-completed", onClick: () => this.props.onVisibilityChanged(todo_1.todoVisibility.SHOW_COMPLETED) }),
            React.createElement("label", { htmlFor: "show-completed" }, "Completed")));
    }
}
const dispatchToProp = (dispatch) => {
    return {
        onVisibilityChanged: (visibility) => {
            dispatch(todo_1.TodoActionCreator.changeVisibility(visibility));
        },
    };
};
exports.default = react_redux_1.connect(null, dispatchToProp)(TodoVisibilitySelector);
...
const react_redux_1 = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
const App_1 = __webpack_require__(/*! ./component/App */ "./src/component/App.tsx");
const index_1 = __webpack_require__(/*! ./store/index */ "./src/store/index.ts");
ReactDOM.render(React.createElement(react_redux_1.Provider, { store: index_1.store },
...
Object.defineProperty(exports, "__esModule", { value: true });
const todoAction = __webpack_require__(/*! ../action/todo */ "./src/action/todo.ts");
const todo_obj_1 = __webpack_require__(/*! ../lib/todo.obj */ "./src/lib/todo.obj.ts");
const initialState = {
    todos: [],
...
function todoApp(state = initialState, action) {
    ...
    switch (action["type"]) {
        case todoAction.todoActionTypes.ADD_TODO:
            newState.todos = [
                ...state.todos,
                new todo_obj_1.TodoItem(action.id, action.text, todo_obj_1.TodoState.TODO),
            ];
            return newState;
        case todoAction.todoActionTypes.REMOVE_TODO: {
            // Find index to remove and splice it
            const idx = newState.todos.findIndex((obj) => obj.getId() ===
                action.id);
            if (idx < 0) {
                return state;
            }
        ...
        case todoAction.todoActionTypes.COMPLETE_TODO: {
            ...
            newState.todos[idx].setState(todo_obj_1.TodoState.COMPLETED);
            return newState;
        }
        case todoAction.todoActionTypes.CHANGE_VISIBILITY:
            newState.visibility = action.filter;
            return newState;
        default:
            return state;
    }
...
const todo_1 = __webpack_require__(/*! ../reducer/todo */ "./src/reducer/todo.ts");
exports.store = redux.createStore(todo_1.todoApp);
